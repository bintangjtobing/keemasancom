...
(function (global, factory) {
    ...
    var options = {
        ...
        gmapAPI: "AIzaSyDt1NfDQHcVNj57WnX1EbuITxUQKoxVES0",
        scrollOffset: 60,
    ...
    var vars = {
        ...
        get smoothScroll() {
            var value =
                this.elBody.getAttribute("data-smooth-scroll") ||
    ...
    var Core = (function () {
        return {
            ...
            colorScheme: function () {
                ...
                var bodyColorScheme = Core.cookie.get(
                    "__cnvs_body_color_scheme"
                );
            ...
            cookie: (function () {
                return {
                    ...
                    get: function (name) {
                        var decodedCookies = decodeURIComponent(
                            document.cookie
                        );
